...
function check_git_repo() {
    if git rev-parse --is-inside-work-tree >/dev/null 2>&1; then
        ...
        for remote in $(git remote); do
            ...
            if [[ $repo_url == "https://github.com/JettyJiang/open-im-server.git" || \
                  $repo_url == "https://github.com/JettyJiang/open-im-server" || \
                  $repo_url == "git@github.com:JettyJiang/open-im-server.git" ]]; then
...
O:::::::OOO:::::::O p:::::ppppp:::::::pe::::::::e            n::::n    n::::nII::::::IIM::::::M               M::::::M
 OO:::::::::::::OO  p::::::::::::::::p  e::::::::eeeeeeee    n::::n    n::::nI::::::::IM::::::M               M::::::M
   OO:::::::::OO    p::::::::::::::pp    ee:::::::::::::e    n::::n    n::::nI::::::::IM::::::M               M::::::M
    ...
    # Display product URL
    print_with_delay "Discover more and contribute at: https://github.com/JettyJiang/open-im-server" 0.01
