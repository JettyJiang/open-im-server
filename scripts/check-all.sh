...
# READ: https://github.com/JettyJiang/open-im-server/tree/main/scripts/install/environment.sh
...
if [[ $? -ne 0 ]]; then
  ...
  echo "+++ https://github.com/JettyJiang/open-im-server/tree/main/scripts/install/environment.sh +++"
else
