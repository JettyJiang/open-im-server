...
**For detailed understanding of version management and storage of OpenIM and Chat**: [version.md](https://github.com/JettyJiang/open-im-server/blob/main/docs/conversions/version.md)

### OpenIM Image

- Get image version info: [images.md](https://github.com/JettyJiang/open-im-server/blob/main/docs/conversions/images.md)
...
- [OpenIMSDK Issue #432](https://github.com/JettyJiang/open-im-server/issues/432)
- [Notion Link](https://nsddd.notion.site/435ee747c0bc44048da9300a2d745ad3?pvs=25)
- [OpenIMSDK Issue #474](https://github.com/JettyJiang/open-im-server/issues/474)